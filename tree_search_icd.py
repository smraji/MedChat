...
def get_icd_codes(medical_note, model_name="gpt-3.5-turbo", temperature=0.0):
    """
    ...
    Args:
        ...
        model_name (str): The identifier for the language model used in the API (default is 'gpt-3.5-turbo').
